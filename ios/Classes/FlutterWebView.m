  ...
  if (self = [super init]) {
    ...
    if ([initialUrl isKindOfClass:[NSString class]]) {
        ...
        if([initialUrl containsString:@"theme=black"]){
            ...
            _webView.opaque = NO;
            _webView.backgroundColor = [UIColor colorWithRed:29.0 / 255.0 green:29.0 / 255.0 blue:30.0 / 255.0 alpha:1.0];
            _webView.scrollView.backgroundColor = [UIColor colorWithRed:29.0 / 255.0 green:29.0 / 255.0 blue:30.0 / 255.0 alpha:1.0];
            _webView.scrollView.showsVerticalScrollIndicator = false;
